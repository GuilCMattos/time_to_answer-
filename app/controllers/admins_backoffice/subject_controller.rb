class AdminsBackoffice::SubjectController < AdminsBackofficeController
    ...
    def create
        ...
        if @subject.save
            redirect_to admins_backoffice_subjects_path, notice: "Assunto/Àrea cadastrado com sucesso!"
        else 
            render :new
        end
    end
    ...
    def update
        if @subject.update(params_subject)
            redirect_to admins_backoffice_subjects_path, notice: "Assunto/Àrea atualizado com sucesso!"
        else 
            render :edit
        end
    end
